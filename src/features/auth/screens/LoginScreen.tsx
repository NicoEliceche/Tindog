...
export function LoginScreen() {
  ...
  return <Screen><Layout><Hero><div className="logo"><BrandLogo alt="Tindog" size="md" /></div><span className="kicker">Conectá, cruzá y encontrá su pareja ideal</span><h1>¡Bienvenido a Tindog!</h1><p>Conecta patitas, una tarjeta a la vez.</p></Hero><Card>
      <h2>Acceso rápido</h2>
