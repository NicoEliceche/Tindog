...
export function LoginScreen() {
  ...
  return <Screen><Layout><Hero><div className="logo"><img src={withPublicBasePath('/assets/tindog_patita_logo_black.png')} alt="Tindog" /></div><span className="kicker">Conectá, cruzá y encontrá su pareja ideal</span><h1>¡Bienvenido a Tindog!</h1><p>Conecta patitas, una tarjeta a la vez.</p></Hero><Card>
      <h2>Acceso rápido</h2>
